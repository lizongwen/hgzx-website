		...
		data: function() {
			return {
				...
				news: [{
						...
						id: "1001",
						date: "2017-03-21",
						title: "芜湖新闻联播：惠国征信助力社会信用体系建设",
					},
					{
						typeid: 1,
						id: "1002",
						date: "2017-03-15",
						title: "芜湖新闻网头条新闻：执着博士助力芜湖信用体系示范城市建设",
					},
					{
						name: "newsDetail3",
						typeid: 1,
						id: "1003",
						date: "2017-03-09",
						title: "《大江晚报》信用专栏载文：惠国征信助力构建社会信用体系",
					},
					{
						typeid: 1,
						id: "1004",
						date: "2017-03-08",
						title: "《芜湖日报》头版载文：“惠政平台”助力芜湖信用示范城市建设",
					},
					{
						typeid: 1,
						id: "1005",
						date: "2017-01-25",
						title: "《芜湖日报》载文“扎根芜湖创新创业，征信事业惠国利民”",
					},
					{
						typeid: 1,
						id: "1006",
						date: "2017-01-04",
						title: "惠国征信助力芜湖创建信用示范城市取得初步成效",
					},
					{
						typeid: 1,
						id: "1007",
						date: "2016-11-01",
						title: "中国征信技术获APEC会议肯定",
					},
					{
						typeid: 1,
						id: "1008",
						date: "2016-07-14",
						title: "跨境征信将在中国内地开展业务试点",
					},
				],
				newsDetail: {}
			};
